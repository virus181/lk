...
class Easyway extends ACourier
{
    const CARRIER_KEY = DeliveryHelper::CARRIER_CODE_EASYWAY;
    ...
    public function call()
    {
        ...
        foreach ($shopOrders as $shopId => $shopOrder) {
            if ($shopOrder['isNeedCall'] || !$shopOrder['isCalled']) {
                ...
                if ($courier->save()) {
                    $courier->sendCourierNotification($shopOrder['orders'][0], $courier, 'belinin.va@easyway.ru');
                }
